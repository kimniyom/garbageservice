...
CREATE TABLE `promise` (
  ...
  `levy` int(2) DEFAULT NULL COMMENT 'จำนวนครั้งที่จัดเก็บต่อเดือน',
  `payperyear` decimal(11,2) DEFAULT NULL COMMENT 'ค่าจ้างรวมทิ้งสิ้นต่อปี',
  ...
  `garbageweight` int(3) DEFAULT NULL COMMENT 'ปริมาณขยะ (กิโลกรัมกนณีเก็บเป็นรายครั้ง)',
  ...
  `unitprice` decimal(11,2) DEFAULT NULL COMMENT 'ราคาต่อหน่วย',
  `distcountpercent` int(3) DEFAULT '0' COMMENT 'ส่วนลด %',
  `distcountbath` decimal(7,2) DEFAULT '0.00' COMMENT 'ส่วนลด(บาท)',
  `total` decimal(11,2) DEFAULT NULL COMMENT 'ราคาหลังหักส่วนลด(บาท)',
  `fine` int(11) DEFAULT NULL COMMENT 'ค่าปรับกรณีเก็บเกิน(กิโลกรัมละ)',
  ...
  `contracktor` int(1) DEFAULT NULL COMMENT '1=บริษัท ไอซี ควอลิตี้ซิสเท็ม จำกัด  โดย นายนิติพัฒน์   วงศ์ศิริธร 2 = ไอซี ควอลิตี้ซิสเท็ม   โดย นายอาทิตย์  บุญเคน',
  PRIMARY KEY (`id`),
