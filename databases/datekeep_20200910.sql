...
CREATE TABLE `datekeep` (
  ...
  `title` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'ข้อความแสดง',
...
-- ----------------------------
BEGIN;
INSERT INTO `datekeep` VALUES (3, '???????????', '2020-08-20', '0000-00-00', 0);
INSERT INTO `datekeep` VALUES (3, 'เข้าจัดเก็บ', '2020-09-01', '0000-00-00', 0);
COMMIT;
