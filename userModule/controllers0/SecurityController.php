...
class SecurityController extends Controller
{
    ...
    public function actionLogin()
    {
        ...
        if ($model->load(\Yii::$app->getRequest()->post()) && $model->login()) {
            ...
            //return $this->goBack();
            if(\Yii::$app->user->identity->status == "U"){
                return $this->redirect(\Yii::$app->urlManager->createUrl(['customer/customers']));
            } else {
                return $this->redirect(\Yii::$app->urlManagerBackend->createUrl(['index.php?r=site']));
            }
        }
