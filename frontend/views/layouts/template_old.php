    ...
    <head>
        ...
        <style type="text/css">
            ...
            .top_bar{
                /*
                background: #0074ff;
                background: -webkit-linear-gradient(to right, #0074ff, #00d3ff);
                background: linear-gradient(to right, #0074ff, #00d3ff);
                */
            }
            #link_hover{
                color: #ffffff;
    ...
    <body>
        ...
        <div class="super_container">
            ...
            <header class="header">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col d-flex flex-row">
                                <div class="logo" style=" margin-right: 10px; padding-top: 5px;">
                ...
                <nav id="navbar" class="navbar navbar-expand-lg navbar-light" style="background: #FFFFFF;">
                    <div class="container">
