...
<div style="font-family:sarabun;font-size:16px;">
    ...
    <div style="text-align: justify;">
        ...
        <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 3 </strong> “ผู้ว่าจ้าง”  ตกลงจ่าย  และผู้รับจ้างตกลงรับเงินค่าจ้างเป็นราย รายครั้ง  รวม  12  เดือน โดยกำหนดค่าจ้างตามน้ำหนักไม่เกิน 10 กิโลกรัมต่อครั้ง  ปริมาณน้ำหนักขยะส่วนที่เกิน  10 กิโลกรัมขึ้นไป ทางบริษัทฯ จะคิดค่าขยะส่วนที่เกิน  เพิ่มกิโลกรัมละ 15 บาท ขยะที่“ผู้รับจ้าง” เก็บขนย้ายไปทำลายในแต่ละเดือน  คิดค่าจ้างเหมาในอัตราครั้งละ <?php echo number_format($model['rate']);?> บาท (  จำนวนบาทถ้วนตัวอักษร.............)  จัดเก็บ <?php echo $model['levy'];?> ครั้งต่อ เดือน เป็นค่าจ้างรวมทั้งสิ้นต่อปี <?php echo $model['payperyear'];?>บาท ( บาทถ้วนตัวอักษร)  โดยกำหนดจ่ายภายใน  30 วัน นับตั้งแต่วันที่ “ผู้ว่าจ้าง” หรือตัวแทนของ “ผู้ว่าจ้าง” ได้ทำการตรวจรับถูกต้องเรียบร้อยแล้ว
