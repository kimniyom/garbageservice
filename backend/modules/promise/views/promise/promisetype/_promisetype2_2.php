...
<div style="font-family:sarabun;font-size:16px;">
    ...
    <div style="text-align: justify;">
        ...
        <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 3 </strong> “ผู้ว่าจ้าง”  ตกลงจ่าย  และผู้รับจ้างตกลงรับเงินค่าจ้างโดยคิดค่าจ้างตามปริมาณน้ำหนักขยะ ที่ "ผู้รับจ้าง" เก็บขนย้ายไปทำลายในแต่ละเดือน ในอัตรากิโลกรัมละ <?php echo number_format($model['unitprice']+(($model['unitprice']*7)/100));?> บาท (<?php echo $Config->Convert($model['unitprice']+(($model['unitprice']*7)/100))?>) ราคานี้รวมภาษีมูลค่าเพิ่ม  7 % แล้ว จัดเก็บ <?php echo $model['levy'];?> ครั้งต่อเดือน  โดยกำหนดจ่ายภายใน  30 วัน นับตั้งแต่วันที่ “ผู้ว่าจ้าง” หรือตัวแทนของ “ผู้ว่าจ้าง” ได้ทำการตรวจรับ ถูกต้องเรียบร้อยแล้ว
