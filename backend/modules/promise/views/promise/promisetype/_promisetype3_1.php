...
<div style="font-family:sarabun;font-size:16px;">
    ...
    <?php 
        ...
        <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 2 </strong>“ผู้รับจ้าง” ตามข้อ 1 สัญญาว่าจะเริ่มนับตั้งแต่  วันที่ <?php echo $Config->thaidate($model['promisedatebegin']);?> ถึงวันที่ <?php echo $Config->thaidate($model['promisedateend']);?> รวมระยะเวลา 12 เดือน  ถ้าผู้รับจ้างมิได้ลงมือทำงานภายในกำหนดเวลา  หรือมีเหตุให้เชื่อได้ว่าผู้รับจ้างไม่สามารถทำงานให้แล้วเสร็จภายในกำหนดเวลา  หรือล่าช้าเกินกว่ากำหนดเวลา   หรือผู้รับจ้างทำผิดข้อตกลงข้อใดข้อหนึ่ง  ผู้ว่าจ้างมีสิทธิที่จะบอกเลิกจ้างตามบันทึกนี้ได้ 
        <?php if($model['payment'] == 0){?>   
            <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 3 </strong> “ผู้ว่าจ้าง”  ตกลงจ่าย และผู้รับจ้างตกลงรับเงินค่าจ้างเป็นรายเดือน รวมระยะเวลา  12 เดือน  โดยกำหนดค่าจ้างตามปริมาณน้ำหนักขยะไม่เกิน <?php echo $model['garbageweight']?> กิโลกรัมต่อครั้ง ในอัตราเหมาจ่ายเดือนละ <?php echo number_format($model['rate']);?> บาท (<?php echo $Config->Convert($model['rate'])?>) ราคาไม่รวมภาษีมูลค่าเพิ่ม ส่วนปริมาณน้ำหนักขยะส่วนที่เกิน  <?php echo $model['garbageweight']?> กิโลกรัมขึ้นไป   ทางบริษัทฯ จะคิดค่าขยะเพิ่มกิโลกรัมละ <?php echo number_format($model['fine'])?> บาท (<?php echo $Config->Convert($model['fine'])?>) ราคาไม่รวมภาษีมูลค่าเพิ่ม “ผู้รับจ้าง” จะทำการเก็บ ขนย้ายไปทำลายในแต่ละเดือน  โดยเข้าจัดเก็บเดือนละ <?php echo $model['levy'];?> ครั้ง  รวม <?php echo $model['levy']*12;?> ครั้งต่อปี  คิดเป็นค่าจ้างรวมทั้ง 12 เดือน <?php echo  number_format($model['total'])?> บาท (<?php echo $Config->Convert($model['total'])?>) ราคาไม่รวมภาษีมูลค่าเพิ่ม  โดยกำหนดจ่ายภายใน  30  วัน นับตั้งแต่วันที่ “ผู้ว่าจ้าง” หรือตัวแทนของ   “ผู้ว่าจ้าง” ได้ทำการตรวจรับถูกต้องเรียบร้อยแล้ว
        <?php }else if($model['payment'] == 1){?>
               <br> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 3 </strong> “ผู้ว่าจ้าง”  ตกลงจ่าย และผู้รับจ้างตกลงรับเงินค่าจ้างเป็นรายปี รวมระยะเวลา  1 ปี  โดยกำหนดค่าจ้างตามปริมาณน้ำหนักขยะไม่เกิน <?php echo $model['garbageweight']?> กิโลกรัมต่อครั้ง ในอัตราเหมาจ่ายเดือนละ <?php echo number_format($model['rate']);?> บาท (<?php echo $Config->Convert($model['rate'])?>) ราคาไม่รวมภาษีมูลค่าเพิ่ม ส่วนปริมาณน้ำหนักขยะส่วนที่เกิน  <?php echo $model['garbageweight']?> กิโลกรัมขึ้นไป   ทางบริษัทฯ จะคิดค่าขยะเพิ่มกิโลกรัมละ <?php echo number_format($model['fine'])?> บาท (<?php echo $Config->Convert($model['fine'])?>) ราคาไม่รวมภาษีมูลค่าเพิ่ม “ผู้รับจ้าง” จะทำการเก็บ ขนย้ายไปทำลายในแต่ละเดือน  โดยเข้าจัดเก็บเดือนละ <?php echo $model['levy'];?> ครั้ง  รวม <?php echo $model['levy']*12;?> ครั้งต่อปี <?php echo $discount; ?> คิดเป็นค่าจ้างรวมทั้งปี <?php echo  number_format($model['total'])?> บาท (<?php echo $Config->Convert($model['total'])?>) ราคาไม่รวมภาษีมูลค่าเพิ่ม  โดยกำหนดจ่ายภายใน  30  วัน นับตั้งแต่วันที่ “ผู้ว่าจ้าง” หรือตัวแทนของ   “ผู้ว่าจ้าง” ได้ทำการตรวจรับ ถูกต้องเรียบร้อยแล้ว
        <?php }?>

        <?php  if($model['payment'] == 0){?>   
            <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 3 </strong> “ผู้ว่าจ้าง”  ตกลงจ่าย และผู้รับจ้างตกลงรับเงินค่าจ้างเป็นรายเดือน รวมระยะเวลา  12 เดือน  โดยกำหนดค่าจ้างตามปริมาณน้ำหนักขยะไม่เกิน <?php echo $model['garbageweight']?> กิโลกรัมต่อครั้ง ในอัตราเหมาจ่ายเดือนละ <?php echo number_format($model['rate']);?> บาท (<?php echo $Config->Convert($model['rate'])?>) ราคาไม่รวมภาษีมูลค่าเพิ่ม ส่วนปริมาณน้ำหนักขยะส่วนที่เกิน  <?php echo $model['garbageweight']?> กิโลกรัมขึ้นไป   ทางบริษัทฯ จะคิดค่าขยะเพิ่มกิโลกรัมละ <?php echo number_format($model['fine'])?> บาท (<?php echo $Config->Convert($model['fine'])?>)  “ผู้รับจ้าง” จะทำการเก็บ ขนย้ายไปทำลายในแต่ละเดือน  โดยเข้าจัดเก็บเดือนละ <?php echo $model['levy'];?> ครั้ง  รวม <?php echo $model['levy']*12;?> ครั้งต่อปี  คิดเป็นค่าจ้างรวมทั้ง 12 เดือน <?php echo  number_format($model['total'])?> บาท (<?php echo $Config->Convert($model['total'])?>)   โดยกำหนดจ่ายภายใน  30  วัน นับตั้งแต่วันที่ “ผู้ว่าจ้าง” หรือตัวแทนของ   “ผู้ว่าจ้าง” ได้ทำการตรวจรับถูกต้องเรียบร้อยแล้ว
        <?php }else if($model['payment'] == 3){?>
               <br> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 3 </strong> “ผู้ว่าจ้าง”  ตกลงจ่าย และผู้รับจ้างตกลงรับเงินค่าจ้างเป็นรายเดือน รวมระยะเวลา  12 เดือน โดยกำหนดค่า่จ้างตามปริมาณน้ำหนักขยะ  ในอัตราค่่าบริการกิโลกรัมละ <?php echo number_format($model['rate']);?> บาท (<?php echo $Config->Convert($model['rate'])?>) ราคาไม่รวมภาษีมูลค่าเพิ่ม  “ผู้รับจ้าง” จะทำการเก็บ ขนย้ายไปทำลายในแต่ละเดือน  โดยเข้าจัดเก็บทุกสัปดาห์ สัปดาห์ละ <?php echo $model['levy'];?> ครั้ง   (ทุกวันอังคาร)  โดยกำหนดจ่ายภายใน  30  วัน นับตั้งแต่วันที่ “ผู้ว่าจ้าง” หรือตัวแทนของ   “ผู้ว่าจ้าง” ได้ทำการตรวจรับ ถูกต้องเรียบร้อยแล้ว
        <?php }else if($model['payment'] == 5){?>
               <br> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 3 </strong> “ผู้ว่าจ้าง”  ตกลงจ่าย และผู้รับจ้างตกลงรับเงินค่าจ้างเป็นรายครึ่งปี รวมระยะเวลา  1 ปี  โดยกำหนดค่าจ้างตามปริมาณน้ำหนักขยะไม่เกิน <?php echo $model['garbageweight']?> กิโลกรัมต่อครั้ง ในอัตราครั้งละ <?php echo number_format($model['rate']);?> บาท (<?php echo $Config->Convert($model['rate'])?>) ราคาไม่รวมภาษีมูลค่าเพิ่ม ส่วนปริมาณน้ำหนักขยะส่วนที่เกิน  <?php echo $model['garbageweight']?> กิโลกรัมขึ้นไป   ทางบริษัทฯ จะคิดค่าขยะเพิ่มกิโลกรัมละ <?php echo number_format($model['fine'])?> บาท (<?php echo $Config->Convert($model['fine'])?>)  “ผู้รับจ้าง” จะทำการเก็บ ขนย้ายไปทำลายในแต่ละเดือน  โดยเข้าจัดเก็บเดือนละ <?php echo $model['levy'];?> ครั้ง  รวม <?php echo $model['levy']*12;?> ครั้งต่อปี <?php echo $discount; ?> คิดเป็นค่าจ้างรวมทั้งปี <?php echo  number_format($model['total'])?> บาท (<?php echo $Config->Convert($model['total'])?>)   โดยกำหนดจ่ายภายใน  30  วัน นับตั้งแต่วันที่ “ผู้ว่าจ้าง” หรือตัวแทนของ   “ผู้ว่าจ้าง” ได้ทำการตรวจรับ ถูกต้องเรียบร้อยแล้ว       
        <?php }else if($model['payment'] == 6){?>
               <br> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 3 </strong> “ผู้ว่าจ้าง”  ตกลงจ่าย และผู้รับจ้างตกลงรับเงินค่าจ้างเป็นรายปี รวมระยะเวลา  12 เดือน  โดยกำหนดค่าจ้างตามปริมาณน้ำหนักขยะไม่เกิน <?php echo $model['garbageweight']?> กิโลกรัมต่อครั้ง ปริมาณที่มีน้ำหนักขยะเกิน 10 กิโลกรัมขึ้นไปทางบริษัทจะคิดค่าขยะเพิ่มกิโลกรัมละ  <?php echo number_format($model['fine']);?> บาท  ขยะที่  “ผู้รับจ้าง” เก็บขนย้ายไปทำลายในแต่ละเดือน คิดค่าจ้างเหมาในอัตราเดือนละ <?php echo number_format($model['rate']);?> บาท (<?php echo $Config->Convert($model['rate'])?>) ราคาไม่รวมภาษีมูลค่าเพิ่ม จัดเก็บ <?php echo $model['levy'];?> ครั้ง ต่อเดือน <?php echo $discount; ?> เป็นค่าจ้างรวมทิ้งสิ้นต่อปี <?php echo number_format($model['total']);?> บาท (<?php echo $Config->Convert($model['total'])?>)    โดยกำหนดจ่ายภายใน  30  วัน นับตั้งแต่วันที่ “ผู้ว่าจ้าง” หรือตัวแทนของ   “ผู้ว่าจ้าง” ได้ทำการตรวจรับถูกต้องเรียบร้อยแล้ว
        <?php }?>
        <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>ข้อ 4 หน้าที่รับผิดชอบของ “ผู้รับจ้าง”</strong>
        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.1 “ผู้รับจ้าง”  จะต้องทำการเก็บขนย้ายและกำจัดขยะมูลฝอยติดเชื้อ โดยใช้พนักงานที่มีความรู้ ผ่านการอบรมการกำจัดขยะติดเชื้อและขนย้าย  เพื่อป้องกันอันตรายจากการเก็บขยะ และปฏิบัติตามหลักเกณฑ์ที่กฎหมาย และระเบียบได้กำหนดไว้อย่างเคร่งครัด  เพื่อให้เป็นไปตามกฎกระทรวงสาธารณสุข ว่าด้วยการกำจัดขยะมูลฝอยติดเชื้อ พ.ศ. 2545
        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.2 “ผู้รับจ้าง” จะต้องเป็นผู้มีอาชีพรับจ้างขนและกำจัดขยะมูลฝอยติดเชื้อ ที่มีสถานที่ผู้ได้รับใบอนุญาตกำจัดขยะมูลฝอยติดเชื้อ ซึ่งเป็นนิติบุคคล ผู้มีอาชีพรับจ้างกำจัดขยะมูลฝอยติดเชื้อ  ไว้รองรับการกำจัดขยะมูลฝอยติดเชื้อ โดยวิธีเผาในเตาเผาขยะมูลฝอยติดเชื้อ  ตลอดระยะเวลาตามสัญญานี้ด้วย
