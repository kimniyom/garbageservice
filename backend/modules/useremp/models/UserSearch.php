...
/**
 * UserSearch represents the model behind the search form of `app\modules\useremp\models\User`.
 */
class UserSearch extends User
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'email', 'password_hash', 'auth_key', 'unconfirmed_email', 'registration_ip', 'status'], 'safe'],
        ];
    }
