...
$this->params['breadcrumbs'][] = ['label' => 'ยืนยันการชำระเงิน', 'url' => ['pertimepay']];
...
<?php
$url = Yii::$app->urlManager->createUrl(['confirmform/confirmform/saveconfirmorder']);
...
<script type="text/javascript">
    function Success() {
        Swal.fire({
            ...
            if (result.value) {
                window.location = "<?php echo Yii::$app->urlManager->createUrl(['confirmform/confirmform/pertimepay']) ?>";
            }
        });
    }
