...
$Config = new Config();
$arrayDate = array('2', '4', '5'); //ไม่เอาวันที่
echo $customer['grouptype'];
?>
        ...
        <tfoot>
            <?php if ($vat == 1) { ?>
                ...
                <tr>
                    ...
                    <th style="text-align:center;">ภาษีมูลค่าเพิ่ม 7%</th>
                    <th style="text-align:right;">
                        <?php
                        //คำนวน vat
                        $vatbath = (($sum * 7) / 100);
            ...
            <tr>
                ...
                <th style="text-align:center;">จำนวนเงินทั้งสิ้น</th>
                <th style="text-align:right;"><?php echo number_format($sumVat, 2) ?></th>
            </tr>
            <tr>
                <th colspan="6">
