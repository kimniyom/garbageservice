...
<script type="text/javascript">
    ...
    function getRound() {
        ...
        var month = $("#month").val();
        var year = $("#year").val();
        var url = "<?php echo Yii::$app->urlManager->createUrl(['service/default/genformgarbageover']) ?>" + "&groupid=" + groupid + "&year=" + year + "&month=" + month;
        window.location = url;
    }
    ...
    function getData() {
        ...
        var url = "<?php echo Yii::$app->urlManager->createUrl(['service/default/getroudinmonthgarbageover']) ?>";
        if (promise == "") {
